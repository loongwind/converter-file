        ...
        return new ForwardingSink(sink) {
            ...
            public void write(Buffer source, long byteCount) throws IOException {
                ...
                Observable.just(progressListener)
                        .filter(new Func1<ProgressRequestListener, Boolean>() {
                            @Override
                            public Boolean call(ProgressRequestListener listener) {
                                return listener != null;
                            }
                        })
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe(new Action1<ProgressRequestListener>() {
                            @Override
                            public void call(ProgressRequestListener listener) {
